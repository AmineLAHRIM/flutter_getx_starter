...
/*
* this is Appear when you want to Read More about a long Text
* */
class CustomReadMore extends StatefulWidget {
  ...
  @override
  CustomReadMoreState createState() => CustomReadMoreState();
}
...
class CustomReadMoreState extends State<CustomReadMore> {
  bool _readMore = true;
